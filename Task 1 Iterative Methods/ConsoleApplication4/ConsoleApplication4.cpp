...
void bisection(double leftBorder, double rightBorder) {
	...
	cout << "	Приближенное решение: " <<fixed<< setprecision(15) << c << endl;
	cout << "	Длина последнего отрезка: " << setprecision(15) << fabs(b - a) << endl;
	cout << "	Невязка: " << setprecision(15) << fabs(f(c)) << endl;;
}
...
void newton(double leftBorder, double rightBorder) {
	...
	cout << "	Количество шагов: " << N << endl;
	cout << "	Приближенное решение: " <<setprecision(12)<< xn << endl;
	cout << "	|x_n - x_(n-1)| = " << setprecision(12)<< fabs(xn - xn1) << endl;
	cout << "	Невязка: " << setprecision(15) << fabs(f(xn))<<endl;
...
void upgradedNewton(double leftBorder, double rightBorder) {
	...
	cout << "	Количество шагов: " << N << endl;
	cout << "	Приближенное решение: " << setprecision(12) << xn << endl;
	cout << "	|x_n - x_(n-1)| = " << setprecision(15) << fabs(xn - xn1) << endl;
	cout << "	Невязка: " << setprecision(15) << fabs(f(xn))<<endl;
}
